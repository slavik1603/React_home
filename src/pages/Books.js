...
import FonBoks from '../assets/FonBoks.jpg'

const useStyles = makeStyles(() => ({
    cardFonBoks: {
        backgroundImage: `url("${FonBoks}")`,
    },
    spanName: {
        color: '#ad0fee',
        fontWeight: 'bold',
    ...
    cardStyle: {
        ...
        backgroundColor: 'rgb(59, 15, 15, 0.5)',
    },
    cardImg: {
        marginTop: '5px',
        width: '230px',
...
export const Books = () => {
    ...
    return (
        <>
            <Card className={classes.cardFonBoks}>
                        ...
                        <Col>
                            <Card className={classes.cardStyle}>
                                ...
                                <Card.Body className={classes.cardBody}>
                                    <Card.Title
                                        className={classes.cardTitleBoks}
                                    >
                                        Books
                                    </Card.Title>
